...
@customElement('w3m-validation-loader')
export class W3mValidationLoader extends LitElement {
  ...
  public startSpinner() {
    const spinnerElement = spinnerRef.value as Element
    const buttonElement = this.button as Element
    animate(buttonElement, { opacity: 0 }, { duration: 0.3, easing: 'ease-in' })
  ...
  public resetSpinner() {
    ...
    const errorElement = errorRef.value as Element
    const buttonElement = this.button as Element
    animate(buttonElement, { opacity: 1 }, { duration: 0.3, delay: 0.3, easing: 'ease-in' })
  ...
  public stopSpinner() {
    ...
    animate(buttonElement, { opacity: 1 }, { duration: 0.3 })
  }
  ...
  protected render() {
    return html`
      ...
      <svg ${ref(checkmarkRef)} class="checkmark" width="13" height="12" viewBox="0 0 13 12">
        <path
          fill-rule="evenodd"
          clip-rule="evenodd"
      ...
      <svg ${ref(errorRef)} class="error" width="12" height="12" viewBox="0 0 12 12">
        <path
...
declare global {
  interface HTMLElementTagNameMap {
    'w3m-validation-loader': W3mValidationLoader
  }
}
